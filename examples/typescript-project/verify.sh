#!/bin/bash
# Verify harness integration against this TypeScript fixture's pre-existing,
# realistic .gitignore and project layout.

echo "Verifying harness integration (typescript-project)..."
echo ""
...
for entry in "node_modules/" "dist/" "*.tsbuildinfo"; do
...
[ -f "package.json" ] && echo "✅ Fixture's own content untouched" || { echo "❌ Fixture's own content missing"; STATUS=1; }
